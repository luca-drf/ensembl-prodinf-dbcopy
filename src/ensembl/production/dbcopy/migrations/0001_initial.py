    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('src_incl_db', NullTextField(blank=True, max_length=2048, null=True)),
                ('src_skip_db', NullTextField(blank=True, max_length=2048, null=True)),
                ('src_incl_tables', NullTextField(blank=True, max_length=2048, null=True)),
                ('src_skip_tables', NullTextField(blank=True, max_length=2048, null=True)),
                ('tgt_host', models.TextField(max_length=2048)),
                ('tgt_db_name', NullTextField(blank=True, max_length=2048, null=True)),
                ('tgt_directory', NullTextField(blank=True, max_length=2048, null=True)),
