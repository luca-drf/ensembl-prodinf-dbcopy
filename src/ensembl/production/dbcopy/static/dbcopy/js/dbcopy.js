...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        trs.has("td.field-list_status div.Complete").addClass('Complete');
        trs.has("td.field-list_status div.Running").addClass('Running');
        trs.has("td.field-list_status div.Incomplete").addClass('Incomplete');
        trs.has("td.field-list_status div.Submitted").addClass('Submitted');
        trs.has("td.field-list_status div.Scheduled").addClass('Scheduled');
        trs.has("td.field-list_status div.Failed").addClass('Failed');
        let tds = $("#changelist-form tr td.field-list_status");
